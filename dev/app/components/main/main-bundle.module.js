...
const moduleName = 'main-bundle',
      components = [ ActivateProfessor, ApproveHours, ClassForm, Dashboard, EditHours, ImportStudents, Main,
                     ProfessorForm,  Project, ProjectEvaluationForm, ProjectForm, Projects, Reports, Section,
