...
(function () {
    ...
    extendCustomValidations.provider('myValidations', function () {
        ...
        var outOfBoxValidations = [
            {
                customValidationAttribute: 'validationFieldRequired',
                errorMessage: 'Este es un campo requerido',
                validator: function (errorMessageElement, val) {
                    return (/\S/).test(val);
                }
            },
            {
                ...
                errorMessage: 'Las contrase&ntilde;as no coinciden',
            ...
            },
            {
                ...
                errorMessage: 'Por favor ingresar un correo v&aacute;lido',
                validator: function (errorMessageElement, val) {
            ...
            },
            {
                ...
                errorMessage: 'No puede contener ning&uacute;n espacio',
                validateWhileEntering: true,
                validator: function (errorMessageElement, val) {
            ...
            },
            {
                ...
                errorMessage: function (attr) {
                    return 'Ingresar un m&iacute;nimo de ' + getValidationAttributeValue(attr) + ' caracteres';
                },
            ...
            },
            {
                ...
                validator: function (errorMessageElement, val, attr, $element, model, ngModelController, $scope, rawAttr) {
                    ...
                    if (val.length <= parseInt(getValidationAttributeValue(rawAttr), 10)) {
                        ...
                        errorMessageElement.html(customMessage || 'Ingresar un m&aacute;ximo de ' + getValidationAttributeValue(rawAttr) + ' caracteres');
                        return false;
                    }
                }
            },
            {
                ...
                errorMessage: 'Caracteres validos son: A-Z, a-z',
                validateWhileEntering: true,
                validator: function (errorMessageElement, val) {
                    return (/^[a-z]*$/i).test(val);
                }
            ...
            },
            {
                ...
                errorMessage: 'Debe contener al menos una letra may&uacute;scula',
                validator: function (errorMessageElement, val) {
                    return (/^(?=.*[A-Z]).+$/).test(val);
                }
            },
            {
                ...
                errorMessage: 'Debe contener solo n&uacute;meros',
                validator: function (errorMessageElement, val) {
            ...
            },
            {
                ...
                errorMessage: 'Debe contener al menos un n&uacute;mero',
                validator: function (errorMessageElement, val) {
                    return (/^(?=.*[0-9]).+$/).test(val);
                }
            },
            {
                ...
                errorMessage: 'Debe contener al menos una letra del alfabeto',
                validator: function (errorMessageElement, val) {
                    return (/^(?=.*[a-z]).+$/i).test(val);
                }
            },
            {
                ...
                validateWhileEntering: true,
                errorMessage: 'Caracteres v&aacute;lidos: A-Z, a-z, 0-9',
                validator: function (errorMessageElement, val) {
            ...
            },
            {
                ...
                errorMessage: 'Debe ser anterior al d&iacute;a de hoy',
                validator: function (errorMessageElement, val) {
                    var now, dateValue;
                    now = new Date();
            ...
            },
            {
                ...
                errorMessage: function (attr) {
                    return 'Debe ser antes de ' + getValidationAttributeValue(attr);
                },
            ...
            },
            {
                ...
                errorMessage: function (attr) {
                    return 'Debe ser despu&eacute;s de ' + getValidationAttributeValue(attr);
                },
